    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur-md shadow-md py-3' : 'bg-transparent py-5'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <img src="https://upload.wikimedia.org/wikipedia/commons/f/f8/Logo_Instituto_Polit%C3%A9cnico_Nacional.png" alt="IPN" className="h-10 w-auto object-contain drop-shadow-sm" />
          <img src="https://upload.wikimedia.org/wikipedia/commons/4/44/Logo_ESIQIE.png" alt="ESIQIE" className="h-10 w-auto object-contain drop-shadow-sm" />
  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 z-0 bg-slate-900">
        ...
        <img src="https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Industria sustentable" className="absolute inset-0 w-full h-full object-cover opacity-40" />
      </div>
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <FadeIn>
          {/* Logo del Seminario */}
          <img src="U1S1L (1).png" alt="Logo Seminario Economía Circular" className="mx-auto w-32 h-32 md:w-40 md:h-40 mb-6 object-contain drop-shadow-2xl bg-white/90 rounded-3xl p-3 shadow-lg border border-white/20" onError={(e) => e.target.style.display='none'} />
        ...
        <FadeIn delay={100}>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white leading-tight mb-6 drop-shadow-lg">
            Seminario en <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#38BDF8] to-green-300">Economía Circular</span>
          </h1>
        </FadeIn>
...
const Timeline = () => {
  const modules = [
    { week: "Semanas 1-4", title: "Unidad I: Gestión de Proyectos", date: "Módulo 1", desc: "Introducción a la gestión de proyectos, iniciación, planificación, ejecución y metodologías de gestión de proyectos 4.0 enfocadas en sustentabilidad." },
    { week: "Semanas 5-8", title: "Unidad II: Desarrollo Sustentable", date: "Módulo 2", desc: "Antecedentes, cumbres internacionales (Río, Johannesburgo, Kioto), Objetivos de Desarrollo Sostenible (ODS) y Agenda 2030." },
    { week: "Semanas 9-12", title: "Unidad III: Economía Circular", date: "Módulo 3", desc: "Economía lineal vs circular, ecodiseño, ecología industrial, reciclaje, normatividad ambiental aplicable (COA, LAU) y prevención del Greenwashing." },
    { week: "Semanas 13-14", title: "Unidad IV: Industria 4.0 y 5.0", date: "Módulo 4", desc: "Evolución de la revolución industrial, aplicaciones tecnológicas (Big Data, IoT, IA, Robótica) y transición hacia la Industria 5.0." },
    { week: "Semanas 3, 7, 11 y 15", title: "Unidad Transversal", date: "Módulo Transversal", desc: "Metodología de la investigación, propuesta de proyecto, análisis de información y entrega de Proyecto de Investigación." },
  ];
  ...
  return (
    <section id="facilitators" className="py-24 bg-slate-50 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <h4 className="text-2xl font-bold text-slate-800 border-b-2 border-[#0B6A35] pb-2 inline-block mb-8">Facilitadores</h4>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
        ...
        <div>
          <h4 className="text-2xl font-bold text-slate-800 border-b-2 border-[#38BDF8] pb-2 inline-block mb-8">Facilitadoras de Apoyo</h4>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <FadeIn delay={200} className="space-y-8">
            <div className="bg-slate-200 rounded-2xl aspect-video flex items-center justify-center shadow-inner relative overflow-hidden border border-slate-300">
              <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1471&q=80')] bg-cover bg-center opacity-50 mix-blend-multiply"></div>
              <div className="relative z-10 text-center p-6">
                <div className="w-16 h-16 bg-white/90 backdrop-blur rounded-full flex items-center justify-center mx-auto mb-4 cursor-pointer hover:scale-110 transition-transform shadow-lg">
                  <svg className="w-8 h-8 text-[#1D4ED8] ml-1" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg>
                </div>
                <p className="font-bold text-slate-900 drop-shadow-md bg-white/70 px-4 py-1 rounded-full text-sm inline-block">Conoce experiencias anteriores</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md border border-slate-100 relative">
              ...
              <p className="text-slate-600 italic relative z-10 pl-6 text-sm mb-4">
                El seminario me dio las herramientas precisas para implementar proyectos de impacto ambiental real en mi actual empleo. La calidad de los facilitadores es excelente y el enfoque en Industria 4.0 marca la diferencia.
              </p>
              <div className="flex items-center gap-3 pl-6">
                <img src="https://i.pravatar.cc/100?img=32" alt="Egresada" className="w-10 h-10 rounded-full border-2 border-[#1D4ED8]" />
                <div>
                  <div className="font-bold text-slate-900 text-sm">Ana Paola Rdz.</div>
                  <div className="text-xs text-slate-500">Generación 2024</div>
                </div>
              </div>
            </div>
          </FadeIn>
  ...
  return (
    <section id="enroll" className="py-24 bg-white relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Aquí va el iFrame de Microsoft Forms */}
        <div className="bg-slate-50 p-2 sm:p-6 rounded-3xl border border-slate-200 shadow-inner w-full min-h-[600px] flex items-center justify-center">
          <iframe 
            width="100%" 
            height="800px" 
            src="https://forms.office.com/Pages/ResponsePage.aspx?id=DQSIkWdsW0yxEjajBLZtrQAAAAAAAAAAAANAARXYZ1... (REEMPLAZA ESTE ENLACE)" 
            frameBorder="0" 
            style={{ border: 'none', maxWidth: '100%' }}
            allowFullScreen
            title="Formulario de Inscripción"
          >
            <p>Tu navegador no soporta iframes. Por favor, contáctanos directamente.</p>
          </iframe>
        </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
      <div>
        <div className="flex items-center gap-3 mb-4">
          <img src="https://upload.wikimedia.org/wikipedia/commons/f/f8/Logo_Instituto_Polit%C3%A9cnico_Nacional.png" alt="IPN" className="h-10 w-auto opacity-90" />
          <img src="https://upload.wikimedia.org/wikipedia/commons/4/44/Logo_ESIQIE.png" alt="ESIQIE" className="h-10 w-auto opacity-90" />
...
const FloatingWhatsApp = () => (
  <a href="https://wa.me/525512011338" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 w-16 h-16 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300 z-50 group">
